...
ssamatab1 <- read_csv("./shiny_dataset/tidy_ssamatab1.csv")
merged_firearm_mortality <- read_csv("./shiny_dataset/merged_firearm_mortality.csv")
gun_violence_tidy <- read_csv("./shiny_dataset/gun_violence_tidy.csv")
